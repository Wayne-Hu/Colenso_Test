...
const PrivacyPolicyComponent: React.FC = () => {
    ...
    return (
        <div className={styles.main}>
            <header>
                <h1>{t("common:links.privacy-policy")}</h1>
            </header>
            <ContentContainer>
                <section className={styles.content}>
                <p>  ColensoBBDO built the Sample Project app as
                  a Commercial app. This SERVICE is provided by
                  ColensoBBDO  and is intended for use as
                  is.
                </p> <p>
                  ...
                  Sample Project unless otherwise defined in this Privacy Policy.
                  ...
                  this page.
                </p> <p>This policy is effective as of 2020-10-18</p> <p><strong>Contact Us</strong></p> <p>
                  If you have any questions or suggestions about our
                  Privacy Policy, do not hesitate to contact us at 100 College Hill, Auckland 1010.
                </p> <p>
